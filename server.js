...
class Gun {
    constructor(body, info) {
        ...
        this.canShoot = false;
        this.isOnTopOfTheTank = (info.PROPERTIES != null ? info.PROPERTIES.IS_ON_TOP_OF_TANK : undefined) || false;
...
if (this.label === "SX-1") {
  if (this.evolveTick == null || this.evolveTick == undefined) this.evolveTick = 100; 
  // Replace 100 with the amount you want. Warning, it is slow.
  this.evolveTick --;
  if (this.evolveTick <= 0) {
    sockets.broadcast("A strange trembling...");
    setTimeout(() => {
      sockets.broadcast("The SX-1 evolved");
      this.define(Class.sx2);
    }, 3000);
  }
};
    ...
    let makefood = (() => {
        ...
        class FoodSpawner {
            constructor() {
                ...
                // Produce a few more
                for (let i=Math.ceil(Math.abs(ran.gauss(0, 6))); i<=0; i--) {
